...
!(function (t, e) {
    ...
    function r(t) {
        var e,
            n = o;
        if (0.05 <= t - s) for (s = t; n; ) ((e = n.g(n.t, n.p)) !== n.v1 || 0.2 < t - n.t1) && ((n.v2 = n.v1), (n.v1 = e), (n.t2 = n.t1), (n.t1 = t)), (n = n._next);
    }
    function t() {
    ...
    function ea(t, e, n, r, i, o, a) {
        ...
        return n < s ? (s = n) : s < r && (s = r), { max: s, min: s, unitFactor: t.unitFactor };
    }
    function fa(t, e, n) {
    ...
    var v,
        ...
        G = {
                    ...
                    k = N(y)
                        ...
                        : (function _calculateTweenDuration(t, e, n, r, i, o) {
                              ...
                              for (a in ((h = ja(t, m, S, w)), m))
                                  z[a] ||
                                      ((s = m[a]),
                                      O(s) || ((d = d || C(t)) && d.isTracking(a) ? (s = N(s) ? { velocity: s } : { velocity: d.get(a) }) : ((u = +s || 0), (c = Math.abs(u / w)))),
                                      O(s) &&
                                          ((u = N(s.velocity) ? s.velocity : (d = d || C(t)) && d.isTracking(a) ? d.get(a) : 0),
                                          (c = j(r, n, Math.abs(u / fa(s, "resistance", w)))),
                                          (l = (f = parseFloat(S(t, a)) || 0) + ga(u, c)),
                                          "end" in s && ((s = ea(s, h && a in h ? h : l, s.max, s.min, a, m.radius, u)), o && (M === e && (M = m = ca(e)), (m[a] = ba(s, m[a], "end")))),
                                          "max" in s && l > +s.max + 1e-10
                                              ? ((p = s.unitFactor || x.unitFactors[a] || 1), (g = (f > s.max && s.min !== s.max) || (-15 < u * p && u * p < 45) ? r + 0.1 * (n - r) : ha(f, s.max, u)) + i < y && (y = g + i))
                                              : "min" in s &&
                                                l < s.min - 1e-10 &&
                                                ((p = s.unitFactor || x.unitFactors[a] || 1), (g = (f < s.min && s.min !== s.max) || (-45 < u * p && u * p < 15) ? r + 0.1 * (n - r) : ha(f, s.min, u)) + i < y && (y = g + i)),
                                          v < g && (v = g)),
                                      v < c && (v = c));
            ...
            render: function render(t, e) {
                var n = e._pt;
                if ((t = w(e.tween._time / e.tween._dur)) || !E()) for (; n; ) n.set(n.t, n.p, aa(n.s + n.c1 * t + n.c2 * t * t) + n.u, n.d, t), (n = n._next);
